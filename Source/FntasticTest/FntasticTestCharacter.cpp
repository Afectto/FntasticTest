...
AFntasticTestCharacter::AFntasticTestCharacter()
{
...
void AFntasticTestCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AFntasticTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AFntasticTestCharacter::Move);
...
void AFntasticTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AFntasticTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
